...
- [ ] **AGW-03 — Validate, integrate and document workflow Agent delivery.** Full Node/browser suites pass; rendered UI inspected; issue and local validation evidence updated without real inference.
