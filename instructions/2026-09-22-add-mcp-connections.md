...
- [ ] MCP-ADD-05 — End-to-end evidence and delivery. Test real HTTP API entry points and fixture subprocess/HTTP MCP servers with temporary stores. Inspect desktop/mobile screenshots. Record migration, privacy, isolation, adapter and UI evidence in VALIDATION.md. Distinguish fixture transport success, actual installed CLI startup and real inference; no account actions or user workflow runs for routine validation.
