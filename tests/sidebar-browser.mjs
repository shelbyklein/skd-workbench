...
try{
 ...
 assert.equal(await views.locator('.view-icon').count(),9);assert.equal(await page.getByRole('navigation',{name:'Projects',exact:true}).count(),0);
 ...
 assert.deepEqual(errors,[]);console.log('Project sidebar passed: nine icons, scoped view links, active view, planned Scratchpad, dirty guard, All projects, details/add, reload, keyboard and mobile.');
