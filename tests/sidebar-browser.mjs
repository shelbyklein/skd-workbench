...
try{
 ...
 await page.locator('.project-card',{hasText:'Second project'}).first().click();
 ...
 await views.getByRole('link',{name:'Issues',exact:true}).click();await page.waitForFunction(()=>/#issues/.test(location.hash));
 assert.equal(await views.locator('[aria-current]').getAttribute('data-sidebar-view'),'issues');
 ...
 await views.getByRole('link',{name:'System',exact:true}).focus();await page.keyboard.press('Enter');await page.locator('#app').getByRole('heading',{name:'System',exact:true}).waitFor();await page.locator('.sidebar-all-projects').click();await page.locator('.project-card',{hasText:'First project'}).first().click();await page.locator('#app').getByRole('heading',{name:'First project',exact:true}).waitFor();
