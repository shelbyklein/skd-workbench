...
const logs={[c(2)]:'100\0Old change\n',[c(4)]:'300\0Latest step\n200\0First step\n'};
const run=async(folder,args)=>{assert.equal(folder,'/repo');const range=args.find(a=>a.includes('..'));return {ok:true,value:logs[range.split('..')[1]]};};
