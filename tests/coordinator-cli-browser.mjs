...
try{
 ...
 assert.equal(await page.locator('#dock-messages').isHidden(),true);assert.equal(await page.locator('#dock-composer').isHidden(),true,'The CLI view has no message box; the terminal takes typing.');
