...
- Merged the widget with the Home filters/list view, rendered issue Markdown and Playbooks/session-activity work. The server allowlist and offline shell include both `/git-status-ui.js` and `/playbooks-ui.js`; shell cache is `skd-shell-0.5.0-61` with 30 cached assets.
