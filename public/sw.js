const CACHE='skd-shell-0.5.0-162';
const ASSETS=['/coordinator-dock.js','/project-agent-ui.js','/sidebar-texture.png','/briefing-ui.js','/connection-editor.js','/agent-profile-picker.js','/issue-actions-ui.js','/delegations-ui.js','/session-import-ui.js','/workspace-tasks-ui.js','/git-status-ui.js','/agent-card.js','/planning-ui.js','/knowledge-ui.js','/skills-ui.js','/tools-ui.js','/connections-ui.js','/playbooks-ui.js','/controllers-ui.js','/settings-ui.js','/markdown.js','/theme.js','/','/app.js','/issues-ui.js','/terminal-ui.js','/vendor/xterm.js','/vendor/xterm.css','/vendor/fit.js','/vendor/cytoscape.js','/vendor/marked.js','/vendor/dompurify.js','/codex-ui.js','/workflows-ui.js','/pwa.js','/style.css','/icon.svg','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png','/icons/maskable-512.png','/icons/apple-touch-icon.png'];
