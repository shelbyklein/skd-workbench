...
import {mountProjectAgent} from './project-agent-ui.js';
...
function renderProjectOverview(){
 ...
 document.querySelector('[data-view-link="overview"]').insertAdjacentHTML('beforebegin',`<button class="overview-flow" data-view-link="playbooks">${viewIcon('playbooks')}<span class="eyebrow">CAPABILITIES</span><strong>Agents</strong><span>Choose specialized skills and MCP connections.</span><span class="overview-flow-footer">Open Agents <span aria-hidden="true">↗</span></span></button>`);
