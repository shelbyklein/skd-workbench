...
function renderProjects(){
 ...
 mountHomeAgents(homeAgents,{api,notify:toast,onProject:id=>confirmLeave(()=>switchProject(id)),onRun:(id,run)=>confirmLeave(()=>{projectID=id;workflowRunID=run;view='workflow';render();})});
