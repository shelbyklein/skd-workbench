...
function breadcrumbs() {
  ...
  if(!['projects','project','knowledge-global','skills-global','connections-global','playbooks-global'].includes(view)){
...
function shell(content) {
  ...
  const projectScoped=!['projects','knowledge-global','skills-global','connections-global','playbooks-global'].includes(view);
