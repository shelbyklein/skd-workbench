...
export function terminalArgs(r,connectionArgs=[],connectionTools=[]){
 const systemInstructions=[r.agentContext?.skills?.text,r.agentContext?.systemInstructions].filter(Boolean).join('\n\n');
