...
export class CodexRuns{
 constructor(directory,{binary=codexBinary(),discover=()=>discoverCodex(binary),spawnProcess=spawn,timeoutMs=600000}={}){
  this.directory=directory;this.binary=binary;this.discover=discover;this.spawnProcess=spawnProcess;this.timeoutMs=timeoutMs;this.active=null;this.starting=false;this.cleaning=0;this.owner=null;this.onFinish=()=>{};
 ...
 async start(input,project,internal={}){
  ...
  assert(!this.active&&!this.starting&&!this.cleaning,'Another Codex task is already running. Stop or finish it first.',409);
