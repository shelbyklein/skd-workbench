...
export class Workflows{
 ...
 async advance(runID){
  ...
  try{
   ...
   const child=await this.codex.start({task:prompt,mode:r.mode,...r.config[step.id]},r.projectSnapshot,{workflowID:r.id,attemptID:attempt.id,workspace:r.workspace,expectedContext:r.sourceContext,agentContext,shouldLaunch:()=>!this.closed&&this.raw(r.id).status==='launching'});
