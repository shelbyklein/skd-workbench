...
export class Workflows{
 ...
 async start(input,flow,project){
  ...
  try{
   ...
   const r={id:runID,revision:0,flow:copy(flow),issueSnapshots,projectID:project.id,projectSnapshot:copy(project),sourceContext:context,task,acceptance,mode:input.mode,config,agentContexts,maxAttempts:input.maxAttempts,cursor:0,status:'launching',attempts:[],retries:{},workspace:null,createdAt:now(),finishedAt:null,error:null};
