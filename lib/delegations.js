...
export class Delegations{
 ...
 async start(input,project,validateProject=()=>{}){
  ...
  assert(!this.closed&&!this.codex.owner&&!this.codex.active&&!this.codex.starting&&!this.codex.cleaning,'Finish or stop the active execution first.',409);this.codex.projectFree(project.id);
