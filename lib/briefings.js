...
export class Briefings{
 ...
 async tick(){
  ...
  try{
   ...
   const date=previousDate(today),input={date,timezone,synthesize:true,agent:this.schedule.agent,model:this.schedule.model,effort:this.schedule.effort},started=[];
