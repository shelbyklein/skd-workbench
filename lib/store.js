...
export class Store {
  ...
  updateProject(projectID,input){
    ...
    return this.change(d=>{
      ...
      const p={...fields,...(d.projects[index].benchmark?{benchmark:d.projects[index].benchmark}:{}),id:projectID,version:input.version+1,updatedAt:now()};d.projects[index]=p;return p;
    });
  }
  ...
  createRun(input, sourceContext=null, expectedProjectVersion=null) {
    return this.change(d=>{
      ...
      const run=createRun(flow,input,project,sourceContext);
