...
export class ControllerCommands{
 constructor({controllers,store,workflows,playbooks,workspaceTasks,codex,lifecycle,mandates,threads,agents=()=>null}){Object.assign(this,{agents,controllers,store,workflows,playbooks,workspaceTasks,codex,lifecycle,mandates,threads});this.pending=new Set();this.closed=false;this.recover();}
