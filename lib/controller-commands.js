...
export class ControllerCommands{
 constructor({controllers,store,workflows,playbooks,workspaceTasks,codex,lifecycle}){Object.assign(this,{controllers,store,workflows,playbooks,workspaceTasks,codex,lifecycle});this.pending=new Set();this.closed=false;this.recover();}
