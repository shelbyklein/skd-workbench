...
export class CoordinatorSessions{
 ...
 finish(r,reason){
  ...
  const {child,secret,idleTimer,killTimer,waiting,status,lines,lineCount,chain,startupPrompt,...saved}=r;this.data.sessions.push({...saved});this.data.sessions=this.data.sessions.slice(-this.historyLimit);this.persist();
